...
*      lo_column->SET_VISIBLE( '' ).
  ...
  ENDTRY.
    ...
    TRY.
      lo_column = lo_cols->get_column( 'CONCEPTO' ).
      lo_column->set_long_text( 'Concepto' ).    "#EC NOTEXT
      lo_column->set_medium_text( 'Concepto' ).                 "#EC NOTEXT
      lo_column->set_short_text( 'Concepto' ).                  "#EC NOTEXT
      lo_column->set_output_length( 10 ).
    CATCH cx_salv_not_found.                            "#EC NO_HANDLER
  ENDTRY.

    TRY.
      lo_column = lo_cols->get_column( 'TIPO_CONCEPTO' ).
      lo_column->set_long_text( 'Tipo concepto' ).    "#EC NOTEXT
      lo_column->set_medium_text( 'Tipo Conc' ).                 "#EC NOTEXT
      lo_column->set_short_text( 'TiCo' ).                  "#EC NOTEXT
